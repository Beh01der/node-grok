...
export function loadDefault(loadModulesOrCallback?: string[] | { (err: any, collection: GrokCollection) }, callback?: { (err: any, collection: GrokCollection) });

export function loadDefaultSync(loadModules?: string[]): GrokCollection;
